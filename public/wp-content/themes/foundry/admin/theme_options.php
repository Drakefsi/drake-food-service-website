...
if( class_exists('Ebor_Options') ){
	...
	$ebor_options->add_setting('select', 'foundry_use_parallax_on_mobile', 'Use Parallax Images on mobiles also? Yes means you get parallax background images on mobile also, be aware this may not work well on certain devices.', 'site_layout_section', 'no', 50, array('yes' => 'Yes', 'no' => 'No'));
	...
	$ebor_options->add_setting('textarea', 'body_font_url', 'Body Font URL Parameter', 'fonts_section', 'Open+Sans:400,500,600', 15);
	$ebor_options->add_setting('input', 'heading_font', 'Heading Font', 'fonts_section', 'Raleway', 20);
	$ebor_options->add_setting('textarea', 'heading_font_url', 'Heading Font URL Parameter', 'fonts_section', 'Raleway:100,400,300,500,600,700', 25);
